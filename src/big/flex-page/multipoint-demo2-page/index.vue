  ...
  <div class="container">
    <div class="early box-border">
      ...
      >
        ...
        <template v-if="i === 0">
          <div class="right">
            <div v-for="(v, i) in 1" :key="i" class="right-item">
              <div class="barWarp">
                <line-bar />
              </div>
              <span>呼吸道疾病</span>
      ...
      <template v-for="(v, i) in earlyWarning">
        <template v-if="v.title === '网络舆情监控预警'">
          ...
          <div :key="`${i}-value`" :class="getClass('msg-item env nomal-item')">
            ...
            <div class="block">
              <legend-ring-chart />
              <div class="chartText">新增确诊100例</div>
            </div>
            <!-- <svg-icon icon-class="line" class="content-line" /> -->
            <div class="block">
              <legend-ring-chart />
...
import flexBig from '@/minxins/flex-big'
