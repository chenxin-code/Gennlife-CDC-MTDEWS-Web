...
<script>
import SchoolModalList from './SchoolModalList'
import StudentModalList from './StudentModalList'

import { syndromeDictionary, schoolList } from '@/api/real-api'
...
const step = ['city', 'school', 'student'] // 定义层级
