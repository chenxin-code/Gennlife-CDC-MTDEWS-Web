...
<script>
import { syndromeDictionary, syndromePatient } from '@/api/real-api'
...
const typeCode = {
  1: { field: 'flight', label: '症候群人员', otherParam: { warnLevel: 3 }}
...
export default {
  ...
  methods: {
    testClick(data) {
      this.$emit('detail', { name: data.name, cardId: data.cardId })
    },
    initSearch() {
