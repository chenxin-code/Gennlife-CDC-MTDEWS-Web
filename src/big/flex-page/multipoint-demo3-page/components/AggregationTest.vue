  ...
  <div class="detail-wrap">
    <div class="information">
      <div class="image">
        ...
        <!-- <img
          ...
          :onerror="`this.src='${require('@/assets/images/default-head.jpg')}'`"
        /> -->
        <el-avatar :src="data.image" shape="square">
      ...
      <div class="details">
        ...
        <template v-else-if="String(data.crowdCode) === '10'">
          <br>
          <br>
          <div>
            <span :style="{ fontWeight: 600 }">数据来源： 公安</span>
          </div>
          <br>
          <div>
            <span>重点人群分类： 隔离酒店工作人员</span>
          </div>
          <br>
        </template>
        <template v-else>
          ...
          <br>
          <div>
            <span :style="{ fontWeight: 600 }">数据来源： 粤省事</span>
          </div>
          <br>
          <div>
    ...
    <div class="diagnosis">
      <div>
        ...
        <span :style="{ backgroundColor: 'rgb(74 16 16)' }">
          新冠核酸检测结果：
...
.diagnosis > div:not(:last-of-type) {
