          ...
          >
            <div class="content-t-text">
              ...
              <div class="content-t-right">
                <div
                  class="change"
                  :class="{ compareWarn: newCase[i].change > 0 }"
                >
                  {{ newCase[i].change }}
                </div>
...
.left .left-2-item ::v-deep {
  ...
  .el-timeline-item__node--normal {
    ...
    border: getWidth(0.06) solid #ffe7b3;
    background-color: #212342;
    margin-top: 6px;
  }
  .el-timeline-item__tail {
    // left: 0;
    border-left: 0.06rem dashed rgba(#ffffff, 0.3);
  }
}
.inner-content .left ::v-deep .el-timeline-item__content {
...
.inner-content .left ::v-deep .el-timeline-item__timestamp {
  width: getWidth(8.94);
